...
public class Parser {
	...
	private void initialize() {
		...
		String[] temp = new String[] { "sin", "cos", "tan", "log", "ln", "exp", "abs", "sqrt" };
	...
	/**
	 * Sets a variable and their corresponding value, useful when we need evaluate a
	 * function with a specific parameter.
	 * 
	 ...
	 * [+term] [-term] term -> factor[*factor] [/factor] factor -> number, variable,
	 * (expression)
	 * 
	...
	/**
	 * Evaluates the expression passed in the constructor an returns the result. If
	...
	/**
	 * Returns the result of evaluating the expression passed as parameter. If there
	 * exists variables in the expression it's assumed that they have been
	 * initialized, e.g. with setVariable(var, val).
	 * 
