...
public class Plane extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener {
	private int maxX;
	private int maxY;
	private int centerX;
	private int centerY;
	...
	public void drawGrid(Graphics2D g2d) {
		...
		Stroke dash = new BasicStroke(0.5f, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER, 10, new float[] { 8, 4 },
				0);
