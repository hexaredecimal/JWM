...
public class TextScreen extends JTextPane implements ScreenAPI {
	...
	public TextScreen() {
		this(DEFAULT_MAX_LINES, DEFAULT_MAX_CHARS, DEFAULT_FOREGROUND_COLOR, DEFAULT_BACKGROUND_COLOR,
				DEFAULT_FONT_SIZE);
	}

	public TextScreen(int maxLines, int maxChars, Color foregroundColor, Color backgroundColor, int fontSize) {
		...
		setPreferredSize(new Dimension((int) ((getMaxChars() + 0.5) * stringBounds.getWidth()),
