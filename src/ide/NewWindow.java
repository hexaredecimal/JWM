...
public class NewWindow extends JInternalFrame {
	...
	private static final String appName = "KodeKnight Text Editor";
	/**
	...
	private void initComponents() {
		...
		jMenuItemNewScript.setAccelerator(
		...
		jMenuItemNewProject.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N,
		...
		jMenuItemOpenScript.setAccelerator(
		...
		jMenuItem9.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,
				java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
		jMenuItem9.setText("Save as");
		jMenuItem9.setToolTipText("Save under a different name");
		jMenu1.add(jMenuItem9);

		jMenuItem10.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,
		...
		jMenuItem13.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V,
				java.awt.event.InputEvent.SHIFT_MASK | java.awt.event.InputEvent.CTRL_MASK));
		...
		JMenu langs = new JMenu("Languages");
		jMenuBar1.add(langs);

		IdeLanguages[] ls = IdeLanguages.values();
		ArrayList<IdeLanguages> arr = new ArrayList<>();

		for (IdeLanguages lang : ls) {
			arr.add(lang);
		}

		arr.sort(Comparator.naturalOrder());

		for (Object lang : arr.toArray()) {
			JMenuItem language = new JMenuItem(lang.toString());
			language.addActionListener((e) -> {
				int index = jTabbedPane1.getSelectedIndex();
				SynEdit editor = editors.get(index);
				editor.setLanguage(IdeLanguages.valueOf(lang.toString()));
			});
			langs.add(language);
		}
